    ...
    <div class="site-navbar py-2">
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                <div class="logo">
                    <div class="site-logo">
                        <a href="/adminproduct" class="js-logo-clone">Bd Health Care</a>
                    </div>
                </div>
                <div class="main-nav d-none d-lg-block">
                    <nav class="site-navigation text-right text-md-center" role="navigation">
                        <ul class="site-menu js-clone-nav d-none d-lg-block">
                            <li><a href="adminproduct">Home</a></li>
                            <li><a href="/view2">Admin</a></li>
                ...
                <div class="icons">
                    ...
                    <a href="/message" class="icons-btn d-inline-block bag">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0">
                    <a href="adminproduct">Home</a> <span class="mx-2 mb-0">/</span>
